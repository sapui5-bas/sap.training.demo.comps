		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#saptrainingdemocomps-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"saptrainingdemocomps-display": {
								"semanticObject": "saptrainingdemocomps",
								"action": "display",
								"description": "Simple SAPUI5 component",
								"title": "Demo Components",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.training.demo.comps",
									"url": sap.ui.require.toUrl("sap/training/demo/comps")
								}
							}
						}
					}
